...
class FrameCaptureSettings(BaseSettings):
    ...
    model_path: DirectoryPath           # path to model used for assisted labeling
...
class FineTuneSettings(BaseSettings):
    ...
    project_name: str
    model_path: DirectoryPath           # path to model to finetune
    external_finetune: bool             # finetune on external dataset
    external_fintune_yaml: DirectoryPath
    external_finetune_epochs: int
    external_finetune_batch: int
    webcam_finetune: bool               # finetune on webcam dataset
    webcam_finetune_yaml: DirectoryPath
